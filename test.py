...
async def seed_dummy_products(db: Database):
    ...
    dummy_products = [
        ...
        Product(product_name="Flood-windows", glass_general_price=90.0, shipping_glass_supplier_price=9.0,
        ...
        Product(product_name="Butt-glazed", glass_general_price=125.0, shipping_glass_supplier_price=10.0,
                aluminum_frame_price=40.0, stainless_steel_price=0.0, local_shipping_price=0.0,
        ...
        Product(product_name="Fire_window", glass_general_price=110.0, shipping_glass_supplier_price=20.0,
                ...
                install_glass_price=12.0, fix_cost_price=55.0),
        Product(product_name="Bullet-proof_window", glass_general_price=130.0, shipping_glass_supplier_price=10.0,
...
async def seed_dummy_sites(db: Database):
    ...
    dummy_sites = [
        Site(sitename="Greenfield Residential Complex",
             ...
             site_type="Residential", risks=["Fire", "Flood"], user_id=3),
        ...
        Site(sitename="Downtown Office Building",
             ...
             site_type="Commercial", risks=["Fire", "Earthquake"], user_id=3),
    ]
    async with db.async_session() as session:
